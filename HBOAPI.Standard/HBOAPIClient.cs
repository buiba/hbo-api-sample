// <copyright file="HBOAPIClient.cs" company="APIMatic">
// Copyright (c) APIMatic. All rights reserved.
// </copyright>
namespace HBOAPI.Standard
{
    using System;
    ...
    /// </summary>
    public sealed class HBOAPIClient : IConfiguration
    {
        ...
        {
            {
                ...
                {
                    { Server.Server1, "https://oauth.api.hbo.com/auth" },
                    { Server.Server2, "https://comet.api.hbo.com" },
                }
            },
        };
        ...
        /// <summary>
        /// Creates an object of the HBOAPIClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> HBOAPIClient.</returns>
        internal static HBOAPIClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("HBOAPI_STANDARD_ENVIRONMENT");
            string accessToken = System.Environment.GetEnvironmentVariable("HBOAPI_STANDARD_ACCESS_TOKEN");
        ...
        {
            private Environment environment = HBOAPI.Standard.Environment.Production;
