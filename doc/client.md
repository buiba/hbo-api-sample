...
| `ToBuilder()` | Creates an object of the HBO APIClient using the values provided for the builder. | `Builder` |

## HBO APIClient Builder Class

Class to build instances of HBO APIClient.
